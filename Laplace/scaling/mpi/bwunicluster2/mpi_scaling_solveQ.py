...
def main():
    ...
    section = r'solve'
    xydata = plot_strong_scaling(str_method='AVP', str_section=section, str_fem=fem, skip_plotting=True)
    section = r'smooth'
    xydata_smooth = plot_strong_scaling(str_method='AVP',
                                        str_section=section,
                                        str_fem=fem,
                                        ...
                                        other_xydata=xydata)
    section = r'solve'
    xydata = plot_strong_scaling(str_method='AVP', str_section=section, str_fem=fem)
